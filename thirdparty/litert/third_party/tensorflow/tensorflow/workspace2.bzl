...
load("@org_tensorflow//tensorflow/tools/def_file_filter:def_file_filter_configure.bzl", "def_file_filter_configure")
load("@org_tensorflow//tensorflow/tools/toolchains:cpus/aarch64/aarch64_compiler_configure.bzl", "aarch64_compiler_configure")
load("@org_tensorflow//tensorflow/tools/toolchains:cpus/arm/arm_compiler_configure.bzl", "arm_compiler_configure")
load("@org_tensorflow//tensorflow/tools/toolchains/clang6:repo.bzl", "clang6_configure")
load("@org_tensorflow//tensorflow/tools/toolchains/embedded/arm-linux:arm_linux_toolchain_configure.bzl", "arm_linux_toolchain_configure")
load("@org_tensorflow//tensorflow/tools/toolchains/remote:configure.bzl", "remote_execution_configure")
load("@org_tensorflow//tensorflow/tools/toolchains/remote_config:configs.bzl", "initialize_rbe_configs")
load("//third_party:repo.bzl", "tf_http_archive", "tf_mirror_urls")
load("@org_tensorflow//third_party/absl:workspace.bzl", absl = "repo")
load("@org_tensorflow//third_party/benchmark:workspace.bzl", benchmark = "repo")
load("@org_tensorflow//third_party/clang_toolchain:cc_configure_clang.bzl", "cc_download_clang_toolchain")
load("@org_tensorflow//third_party/dlpack:workspace.bzl", dlpack = "repo")
load("@org_tensorflow//third_party/ducc:workspace.bzl", ducc = "repo")
load("@org_tensorflow//third_party/eigen3:workspace.bzl", eigen3 = "repo")
load("@org_tensorflow//third_party/farmhash:workspace.bzl", farmhash = "repo")
load("@org_tensorflow//third_party/flatbuffers:workspace.bzl", flatbuffers = "repo")

# Import third party repository rules. See go/tfbr-thirdparty.
load("@org_tensorflow//third_party/FP16:workspace.bzl", FP16 = "repo")
load("@org_tensorflow//third_party/gemmlowp:workspace.bzl", gemmlowp = "repo")
load("@org_tensorflow//third_party/git:git_configure.bzl", "git_configure")
load("@org_tensorflow//third_party/gpus:rocm_configure.bzl", "rocm_configure")
load("@org_tensorflow//third_party/gpus:sycl_configure.bzl", "sycl_configure")
load("@org_tensorflow//third_party/hexagon:workspace.bzl", hexagon_nn = "repo")
load("@org_tensorflow//third_party/highwayhash:workspace.bzl", highwayhash = "repo")
load("@org_tensorflow//third_party/hwloc:workspace.bzl", hwloc = "repo")
load("@org_tensorflow//third_party/icu:workspace.bzl", icu = "repo")
load("@org_tensorflow//third_party/implib_so:workspace.bzl", implib_so = "repo")
load("@org_tensorflow//third_party/jpeg:workspace.bzl", jpeg = "repo")
load("@org_tensorflow//third_party/kissfft:workspace.bzl", kissfft = "repo")
load("@org_tensorflow//third_party/libprotobuf_mutator:workspace.bzl", libprotobuf_mutator = "repo")
load("@org_tensorflow//third_party/llvm:setup.bzl", "llvm_setup")
load("@org_tensorflow//third_party/nanobind:workspace.bzl", nanobind = "repo")
load("@org_tensorflow//third_party/nasm:workspace.bzl", nasm = "repo")
load("@org_tensorflow//third_party/opencl_headers:workspace.bzl", opencl_headers = "repo")
load("@org_tensorflow//third_party/pasta:workspace.bzl", pasta = "repo")
load("@org_tensorflow//third_party/py:python_configure.bzl", "python_configure")
load("@org_tensorflow//third_party/py/ml_dtypes:workspace.bzl", ml_dtypes = "repo")
load("@org_tensorflow//third_party/pybind11_abseil:workspace.bzl", pybind11_abseil = "repo")
load("@org_tensorflow//third_party/pybind11_bazel:workspace.bzl", pybind11_bazel = "repo")
load("@org_tensorflow//third_party/robin_map:workspace.bzl", robin_map = "repo")
load("@org_tensorflow//third_party/ruy:workspace.bzl", ruy = "repo")
load("@org_tensorflow//third_party/shardy:workspace.bzl", shardy = "repo")
load("@org_tensorflow//third_party/sobol_data:workspace.bzl", sobol_data = "repo")
load("@org_tensorflow//third_party/stablehlo:workspace.bzl", stablehlo = "repo")
load("@org_tensorflow//third_party/systemlibs:syslibs_configure.bzl", "syslibs_configure")
load("@org_tensorflow//third_party/tensorrt:tensorrt_configure.bzl", "tensorrt_configure")
load("@org_tensorflow//third_party/tensorrt:workspace.bzl", tensorrt = "repo")
load("@org_tensorflow//third_party/triton:workspace.bzl", triton = "repo")
load("@org_tensorflow//third_party/vulkan_headers:workspace.bzl", vulkan_headers = "repo")
